...
$query_beca     = "SELECT people_id, beca_estatus, estatus_documentos, beca_tipo_otorgado, beca_otorgado, academic_year, academic_term, academic_session 
...
$query_docs = "SELECT url, estatus FROM beca_aceptar WHERE folio = $folio;";
$cmd = new mssqlCommand($query_docs,$siieCon);
$infocarta = $cmd->ExecuteReader();
$localizar  = $infocarta[0]['url'];//url del documento
$estatus    = $infocarta[0]['estatus'];//estatus del documento
     ...
     <div id="sep3" style="text-align:center; padding:15px;">
        <div style="background-color:#F7F7F7; text-align:center; padding:15px">
            <div style="font-weight: bold; font-size: 20px;">
                ...
                <p>Los Resolutivos de Beca estan siendo Actualizados, los lineamientos de aplicación de Beca serán enviados el día 31 de Enero,</p>
                <p>por favor ingresar al sistema en esa fecha.</p>
                <p>Gracias.</p>
            </div>
            <div>
    ...
    <div id="sep2" style="text-align:center; padding:15px;">
        <div style="background-color:#F7F7F7; text-align:center; padding:15px">
            ...
            ?>
                ...
                <iframe id="c2" src="https://aspaa.uvp.mx/becas/otorgado/<?=$tipobk?>/<?=$nivelbk.$periodobk?>.pdf" style="width:100%; height:800px;" frameborder="0"></iframe>
                <p>
